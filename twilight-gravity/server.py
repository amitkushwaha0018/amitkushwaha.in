        ...
        if clean_path == '/api/info':
            ...
            try:
                ...
                if not info:
                    ...
                    std_video_options = [
                        {'format_id': 'bestvideo[height<=1080]+bestaudio/best[height<=1080]/best', 'quality': '1080p', 'resolution': '1080p Full HD (Original)', 'ext': 'mp4', 'filesize_str': '33.7 MB', 'fps': 30, 'has_audio': True},
